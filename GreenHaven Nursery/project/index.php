            ...
            <div class="col-md-12">
                <div class="banner-content ">
                    <div class="banner-carousel owl-carousel owl-theme">
                        <div class="item">
                            <img src="images/bg.jpg" alt=""/style="background-size: cover;    width="20" height="500">
                        </div>
                        <div class="item">
                            <img src="images/bg1.jpg" alt=""/style="background-size: cover; width="20" height="500">
                        </div>
						 <div class="item">
                            <img src="images/bg2.jpg" alt=""/style="background-size: cover; width="20" height="500">
                        </div>
                    </div>
                </div>
            </div>
